...
/** The class serves to store the object "task" with properties
...
public class Task implements Comparable<Task>, Serializable {
     ...
     * @see TaskStatus
     * @return {@linkplain model.TaskStatus } status
     */
     ...
     * @param status new status from the class {@linkplain model.TaskStatus}
     */
