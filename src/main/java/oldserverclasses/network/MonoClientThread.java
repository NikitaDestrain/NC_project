...
import oldserverclasses.commandproccessor.ServerCommandParser;
...
/**
 * Thread for work with the oldclientclasses.client
 */
...
public class MonoClientThread extends Thread {
    ...
    /**
     * Finishes oldclientclasses.client's thread and close all channels
     */
