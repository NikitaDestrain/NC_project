package oldclientclasses.client.commandprocessor;

import auxiliaryclasses.MessageBox;
import oldclientclasses.client.commandprocessor.commandhandlers.*;
...
/**
 * Parses an incoming command on the oldclientclasses.client side
 */
