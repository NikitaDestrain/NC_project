...
public class ServerCommandSender {
    ...
    public static synchronized ServerCommandSender getInstance() { //todo vlla synchronized DONE
    ...
    public void sendUpdateCommand(Journal journal, OutputStream out) {
        ...
        //todo vlla это уже гораздо лучше в плане обработки ошибки. DONE
    ...
    public void sendNotificationCommand(Task task, OutputStream out) {
        ...
        //todo vlla шесть ваших методов отличаются ТОЛЬКО параметрами у createCommand(). DONE
